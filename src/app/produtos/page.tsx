      ...
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 text-lg max-w-2xl mx-auto">
            Descubra toda nossa coleção de produtos selecionados com carinho
          </p>
        </div>
        ...
        {categories.length > 0 && (
          <div className="mb-12">
            <div className="flex flex-wrap justify-center gap-4">
              <Link
                href="/produtos"
                className="px-6 py-2 border border-black text-black hover:bg-black hover:text-white transition-colors uppercase tracking-wider text-sm"
              >
                Todos
              </Link>
              {categories.map((category) => (
                <Link
                  ...
                  className="px-6 py-2 border border-gray-300 text-gray-700 hover:border-black hover:text-black transition-colors uppercase tracking-wider text-sm"
                >
                  {category.name}
                </Link>
              ))}
        ...
        {products.length === 0 ? (
          <div className="text-center py-16">
            ...
            <p className="text-gray-600 mb-8">
              Ainda não temos produtos disponíveis. Volte em breve!
            </p>
