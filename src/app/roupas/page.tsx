...
export default async function RoupasPage() {
  // Get products from clothing-related categories
  ...
  const allProducts = clothingCategories.flatMap(cat => cat.products);
    ...
    <div className="min-h-screen bg-white">
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Roupas</h1>
        ...
        <div className="mb-8">
          ...
          <div className="flex flex-wrap gap-4">
            <Link href="/roupas/partes-de-cima" className="px-4 py-2 bg-gray-100 rounded-lg hover:bg-gray-200 transition-colors">
              Partes de Cima
            </Link>
            <Link href="/roupas/partes-de-baixo" className="px-4 py-2 bg-gray-100 rounded-lg hover:bg-gray-200 transition-colors">
              Partes de Baixo
            </Link>
          </div>
        </div>
        ...
        {allProducts.length === 0 ? (
          <div className="text-center py-16">
            ...
            <p className="text-sm text-gray-500">
              Para adicionar produtos, acesse o painel administrativo e crie categorias como &quot;Blusas&quot;, &quot;Camisas&quot;, &quot;Shorts&quot;, etc.
            </p>
          </div>
        ) : (
