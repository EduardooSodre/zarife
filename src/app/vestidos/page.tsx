...
export default async function VestidosPage() {
  // Get products from vestido categories
  const vestidoCategories = await prisma.category.findMany({
    where: {
      OR: [
  ...
  const allProducts = vestidoCategories.flatMap(cat => cat.products);
    ...
    <div className="min-h-screen bg-white">
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Vestidos</h1>
        ...
        <div className="mb-8">
          <p className="text-gray-600 text-sm max-w-2xl">
            Encontre o vestido perfeito para cada ocasião. Desde modelos casuais até peças elegantes para eventos especiais.
          </p>
        </div>

        {/* Filter Options */}
        <div className="mb-8">
          <h2 className="text-lg font-semibold text-gray-900 mb-4">Estilos</h2>
        ...
        {allProducts.length === 0 ? (
          <div className="text-center py-16">
            ...
            <p className="text-sm text-gray-500">
              Para adicionar produtos, acesse o painel administrativo e crie categorias como &quot;Vestidos&quot;, &quot;Vestido Longo&quot;, &quot;Vestido Curto&quot;, etc.
            </p>
          </div>
        ) : (
