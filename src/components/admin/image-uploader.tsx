                ...
                <div className="grid grid-cols-3 gap-3">
                    {images.map((image, index) => (
                        <div
                            ...
                            className={`relative group aspect-square bg-gray-100 rounded-lg overflow-hidden border-2 transition-all cursor-move ${draggedIndex === index ? 'opacity-50 border-blue-500' : 'border-gray-200 hover:border-gray-300'
                                }`}
                        >
                            <Image
